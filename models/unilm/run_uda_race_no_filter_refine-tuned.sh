...
SELECTED_FILE=../../data/nq/race_gmm_l2_order/${SELECNUM}.jsonl
# folder used to save fine-tuned checkpoints
OUTPUT_DIR=./nq_unilm_ckpt/race_pseudo_label/ds_finetuned_then_PL/no_filter/
# checkpoint trained on source, need to transfer
CKPT_PATH=./nq_unilm_ckpt/gmm_race_l2_order/${SELECNUM}/ckpt-600/ 
