...
class BertModel(BertPreTrainedForSeq2SeqModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None,
        ...
        extended_attention_mask = extended_attention_mask.to(dtype=torch.float32) # next(self.parameters()).dtype)  # fp16 compatibility
...
class BertForSequenceToSequence(BertPreTrainedForSeq2SeqModel):
    ...
    def forward(self, source_ids, target_ids, pseudo_ids, num_source_tokens, num_target_tokens, target_span_ids=None, scores=None):
        ...
        def loss_mask_and_normalize(loss, mask, scores):
        ...
        pseudo_lm_loss = loss_mask_and_normalize(
            masked_lm_loss.float(), target_mask, scores)
