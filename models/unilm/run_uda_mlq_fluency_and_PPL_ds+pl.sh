...
TRAIN_FILE=../../data/MLQuestions/target.jsonl
# path of selected source data
SELECTED_FILE=../../data/nq/mlq_order/1000.jsonl
# folder used to save fine-tuned checkpoints
OUTPUT_DIR=./nq_unilm_ckpt/mlq_pseudo_label/ds+PL/fluency_and_PPL/${FLUENCY}_${PPL}/
...
CACHE_DIR=./mlq_unilm_ckpt/cache
